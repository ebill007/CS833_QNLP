...
from lambeq.lambeq import (ansatz, core, pregroups, rewrite,
                    text2diagram, tokeniser, training)
from lambeq.lambeq.ansatz import (BaseAnsatz, CircuitAnsatz, IQPAnsatz, MPSAnsatz,
...
from lambeq.lambeq.core.types import AtomicType
from lambeq.lambeq.pregroups import (create_pregroup_diagram, diagram2str,
                              is_pregroup_diagram, remove_cups, remove_swaps)
from lambeq.lambeq.rewrite import (CoordinationRewriteRule, CurryRewriteRule,
                            DiagramRewriter, Rewriter, RewriteRule,
                            SimpleRewriteRule, UnifyCodomainRewriter,
                            UnknownWordsRewriteRule)
from lambeq.lambeq.text2diagram import (
...
from lambeq.lambeq.tokeniser import Tokeniser, SpacyTokeniser
from lambeq.lambeq.training import (Checkpoint, Dataset, Optimizer,
